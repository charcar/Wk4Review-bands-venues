...
ALTER TABLE bands OWNER TO xanadu;

--
-- Name: bands_id_seq; Type: SEQUENCE; Schema: public; Owner: xanadu
--
...
ALTER TABLE bands_id_seq OWNER TO xanadu;

--
-- Name: bands_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: xanadu
--
...
ALTER TABLE bands_venues OWNER TO xanadu;

--
-- Name: bands_venues_id_seq; Type: SEQUENCE; Schema: public; Owner: xanadu
--
...
ALTER TABLE bands_venues_id_seq OWNER TO xanadu;

--
-- Name: bands_venues_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: xanadu
--
...
ALTER TABLE venues OWNER TO xanadu;

--
-- Name: venues_id_seq; Type: SEQUENCE; Schema: public; Owner: xanadu
--
...
ALTER TABLE venues_id_seq OWNER TO xanadu;

--
-- Name: venues_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: xanadu
--
...
--
-- Data for Name: bands; Type: TABLE DATA; Schema: public; Owner: xanadu
--
...
--
-- Name: bands_id_seq; Type: SEQUENCE SET; Schema: public; Owner: xanadu
--
...
--
-- Data for Name: bands_venues; Type: TABLE DATA; Schema: public; Owner: xanadu
--
...
--
-- Name: bands_venues_id_seq; Type: SEQUENCE SET; Schema: public; Owner: xanadu
--
...
--
-- Data for Name: venues; Type: TABLE DATA; Schema: public; Owner: xanadu
--
...
--
-- Name: venues_id_seq; Type: SEQUENCE SET; Schema: public; Owner: xanadu
--
